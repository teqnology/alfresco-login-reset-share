...
<head>
    <title>Alfresco - ${msg("forgotPage.pageTitle")}</title>
                ...
                <div class="col l6 offset-l3 s12 m12">
                    <div class="card z-depth-1">
                        <div class="card-content">
                            <span class="card-title grey-text text-darken-4">${msg("forgotPage.title")}</span>
                            <div class="divider blue"></div>
                            <p>${msg("forgotPage.text")}</p>
                            <form id="form-forgot">
                                <div class="row">
                                ...
                                <button id="form-btn" class="btn waves-effect waves-light blue" type="submit" name="action">${msg("forgotPage.submitButton")}</button>
                                <div class="row"></div>
                            </form>
                        ...
                        <div class="card-action">
                            <a href="${url.context}" class="waves-effect btn grey lighten-5 grey-text text-darken-4" type="submit" name="action">${msg("forgotPage.cancelButton")}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $('#form-forgot').submit(function( event ) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#form-result').text('${msg("forgotPage.checkYourEmail")}');
                },
